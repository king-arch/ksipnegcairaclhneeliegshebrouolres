...
Template.blog_detail1.onDestroyed(function(){
  all_likes.stop();
  all_comments.stop();
  all_followers.stop();
});
   ...
   Template.blog_detail1.onRendered(function(){
     ...
     Session.set("detailed_blog_id","");
       var url = window.location.href;
        ...
        var user_id_by_url = Base64.decode(url); 
         ...
         // t2.detailed_blog_id.set(user_id_by_url);
...
Template.blogdetails1.onRendered(function(){
  window.scrollTo(0,0);
