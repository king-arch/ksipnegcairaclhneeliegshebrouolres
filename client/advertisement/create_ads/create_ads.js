...
Template.ads_create.events({
 ...
 //    }
    ...
    Meteor.call('save_promotion',promotion_id,promotion_title,promotion_type,promotion_url,
    	promotion_content,promotion_start_date,promotion_end_date,function(error,result){
              if(error){
                console.log("Some error occured.");
              }else{ 
               	toastr.success("promotions sucessfully added to ads list!");
