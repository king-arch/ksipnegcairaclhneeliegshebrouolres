...
Template.hub_center_detail.onRendered(function() {
...
$(document).ready(function() {
  window.onscroll = function() {
    ...
    Template.hub_center_detail.__helpers["fetch_hub_posting"]();
    }
}
});
});
...
Template.hub_center_detail.helpers({
...
Template.hub_center_detail.events({
...
'click .modal_kholo':function(){
  ...
  // document.getElementById('abb_khulja').click();
   ...
   if(result>=0){
      ...
      // Template.hub_center_detail.__helpers["fetch_all_liked_users"]();  
   }
